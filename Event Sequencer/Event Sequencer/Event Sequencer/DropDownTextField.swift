...
//  Muzoma
//
//  Created by Matthew Hopkins on 02/04/2017.
...
class DropDownTextField : UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate {
    ...
    @IBOutlet weak var textField: UITextField!//NoCopyPasteUITextField!
    ...
    {
        let cellObj = tableView.dequeueReusableCell(withIdentifier: "cell")
        
        // Set text from the data model
        if( cellObj != nil )
        {
            let cell:UITableViewCell = cellObj!
